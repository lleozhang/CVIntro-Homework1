...
if __name__ == "__main__":
    ...
    for i in range(50):
        ...
        loss_grad = -gt_y / pred_y + (1 - gt_y) / (1 - pred_y)
        pred_grad = loss_grad * pred_y * (1 - pred_y)
        grad_layer_2 = output_layer_1_act.T @ pred_grad
        
        output_act_1_grad = pred_grad @ MLP_layer_2.T 
        output_layer_1_grad = output_act_1_grad * output_layer_1_act * (1 - output_layer_1_act)
        grad_layer_1 = input_vector.T @ output_layer_1_grad 
